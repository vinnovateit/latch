...
internal object LatchIcons {
    ...
    val CheckCircle: ImageVector by lazy {
        icon("check_circle", "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z")
    }
    ...
    val Notifications: ImageVector by lazy {
        icon("notifications", "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z")
    }

    val CaptivePortal: ImageVector by lazy {
        ImageVector.Builder(
            name = "CaptivePortal",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            ...
            pathData = PathParser().parsePathString(
                "M720,777L720,826Q720,843 708.5,854.5Q697,866 680,866Q663,866 651.5,854.5Q640,843 640,826L640,700Q640,675 657.5,657.5Q675,640 700,640L826,640Q843,640 854.5,651.5Q866,663 866,680Q866,697 854.5,708.5Q843,720 826,720L776,720L866,810Q877,821 877,837.5Q877,854 866,866Q854,878 837.5,878Q821,878 809,866L720,777ZM480,880Q397,880 324,848.5Q251,817 197,763Q143,709 111.5,636Q80,563 80,480Q80,397 111.5,324Q143,251 197,197Q251,143 324,111.5Q397,80 480,80Q563,80 636,111.5Q709,143 763,197Q817,251 848.5,324Q880,397 880,480Q880,490 879.5,502Q879,514 878,524Q876,541 864,550.5Q852,560 834,560Q818,560 807,546Q796,532 798,516Q800,506 800,498Q800,490 800,480Q800,460 797.5,440Q795,420 790,400L654,400Q657,420 658.5,440Q660,460 660,480Q660,490 660,501.5Q660,513 659,523Q657,540 645,550Q633,560 616,560Q600,560 588.5,547Q577,534 579,518Q580,508 580,499Q580,490 580,480Q580,460 578.5,440Q577,420 574,400L386,400Q383,420 381.5,440Q380,460 380,480Q380,500 381.5,520Q383,540 386,560L480,560Q497,560 508.5,571.5Q520,583 520,600Q520,617 508.5,628.5Q497,640 480,640L404,640Q416,683 435,722.5Q454,762 480,798Q490,798 500,798.5Q510,799 520,798Q537,796 548,806.5Q559,817 559,834Q559,852 550,864Q541,876 524,878Q514,879 502,879.5Q490,880 480,880ZM170,560L306,560Q303,540 301.5,520Q300,500 300,480Q300,460 301.5,440Q303,420 306,400L170,400Q165,420 162.5,440Q160,460 160,480Q160,500 162.5,520Q165,540 170,560ZM376,782Q358,748 344.5,712.5Q331,677 322,640L204,640Q233,691 277,727.5Q321,764 376,782ZM204,320L322,320Q331,283 344.5,247.5Q358,212 376,178Q321,196 277,232.5Q233,269 204,320ZM404,320L556,320Q544,277 525,237.5Q506,198 480,162Q454,198 435,237.5Q416,277 404,320ZM638,320L756,320Q727,269 683,232.5Q639,196 584,178Q602,212 615.5,247.5Q629,283 638,320Z"
            ).toNodes(),
